...
@test Argo.Properties.infer_property(l1, Argo.Properties.Convexity) ==
    Argo.Properties.Convex()
...
@test Argo.Properties.infer_property(sqrt_expr, Argo.Properties.Monotonicity) ==
    Argo.Properties.Increasing()
